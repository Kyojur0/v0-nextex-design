...
export function PdfPreview({ isBuilding, hasError }: PdfPreviewProps) {
  const [zoom, setZoom] = useState(100)

  return (
    <div className="h-full flex flex-col bg-muted/30">
      {/* Toolbar */}
      <div className="h-9 flex items-center justify-between px-3 border-b border-border bg-background">
      ...
      {/* Preview area */}
      <div className="flex-1 overflow-auto scrollbar-thin p-6 flex justify-center">
        {isBuilding ? (
